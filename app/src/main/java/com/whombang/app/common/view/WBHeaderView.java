...
import com.whombang.app.common.pulltorefresh.PtrUIHandler;
import com.whombang.app.common.pulltorefresh.indicator.PtrIndicator;
...
public class WBHeaderView extends PtrFrameLayout implements PtrUIHandler{
    ...
    public WBHeaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public WBHeaderView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initView();
    }

    private void initView(){
        View view = View.inflate(this.getContext(), R.layout.wb_viewhead_layout,null);

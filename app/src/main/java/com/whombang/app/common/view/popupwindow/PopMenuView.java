package com.whombang.app.common.view.popupwindow;
...
public class PopMenuView {
    ...
    private LinearLayout mTest1Layout, mTest2Layout, mTest3Layout;
    ...
    private void createView(final Context context) {
        this.mRootVew = LayoutInflater.from(context).inflate(R.layout.wb_view_pop_menu_layout, null);
    ...
    private void initLayout(Context context) {
        this.mCloseLayout = this.mRootVew.findViewById(R.id.close_layout);
        this.mCloseIv =  this.mRootVew.findViewById(R.id.close_iv);
        this.mTest1Layout =  this.mRootVew.findViewById(R.id.test1_layout);
        this.mTest2Layout =  this.mRootVew.findViewById(R.id.test2_layout);

package com.whombang.amaplibrary.clustering.view;
...
import com.whombang.amaplibrary.R;
...
import com.whombang.amaplibrary.projection.Point;
import com.whombang.amaplibrary.projection.SphericalMercatorProjection;
import com.whombang.amaplibrary.ui.IconGenerator;
import com.whombang.amaplibrary.ui.SquareTextView;
...
import static com.whombang.amaplibrary.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;


/**
 * 一个ClusterManager的默认视图。标记在集群和集群中都是动态的
 */
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    public DefaultClusterRenderer(Context context, AMap map, ClusterManager<T> clusterManager) {
        ...
        mIconGenerator.setBackground( mContext.getResources().getDrawable(R.mipmap.ico_content_bubble));
    ...
    private LayerDrawable makeClusterBackground() {
        ...
        outline.getPaint().setColor(Color.GREEN); // Transparent white.
...
//        }
//        return String.valueOf(bucket) + "+";
        return bucket+mContext.getResources().getString(R.string.platform);
    }
    ...
    protected void onBeforeClusterRendered(Cluster<T> cluster, MarkerOptions markerOptions) {
        ...
        if (descriptor == null) {
           // mColoredCircleBackground.getPaint().setColor(Color.TRANSPARENT);//getColor(bucket)
            descriptor = BitmapDescriptorFactory.fromBitmap(mIconGenerator.makeIcon(getClusterText(bucket)));
           // descriptor = BitmapDescriptorFactory.fromBitmap(  BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.ico_content_bubble));
